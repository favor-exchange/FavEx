...
public class messageDatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insertData(String message, String sender, String facebookId, String time, String date){
    ...
    public Cursor getMessagesByFacebookId(String facebookId){
        ...
        return db.rawQuery("SELECT * FROM " + TABLE_NAME + " WHERE " + COLUMN_NAME_FBID + " = " + facebookId, null);
    }
}
